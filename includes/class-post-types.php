...
class Live_Quiz_Post_Types {
    ...
    public static function init() {
        ...
        add_action('template_redirect', array(__CLASS__, 'handle_play_template'));
     ...
     * Get play base
     */
    public static function get_play_base() {
        return get_option('live_quiz_play_base', 'play');
    }
    
    /**
     * Flush rewrite rules when play base changes
     */
    public static function flush_rewrite_rules_on_change($old_value, $new_value) {
